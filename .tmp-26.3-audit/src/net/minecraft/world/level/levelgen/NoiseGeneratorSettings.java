...
public record NoiseGeneratorSettings(
	...
	private static NoiseGeneratorSettings end(final BootstrapContext<?> context) {
		...
		return new NoiseGeneratorSettings(
			...
			new NoiseGeneratorSettings.DebugFunctions(
				List.of(new NoiseGeneratorSettings.DebugFunctionEntry("N", router.finalDensity()), new NoiseGeneratorSettings.DebugFunctionEntry("IS", router.erosion()))
			)
		);
	}
	...
	public record DebugFunctions(List<NoiseGeneratorSettings.DebugFunctionEntry> functions) {
