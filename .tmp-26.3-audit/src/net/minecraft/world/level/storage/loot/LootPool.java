...
public class LootPool implements Validatable {
	 ...
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public final Optional<Holder<LootItemCondition>> condition;
	/**
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public final Optional<Holder<LootItemFunction>> modifier;
	/**
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public final Holder<ContextIntProvider> rolls;
	/**
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public final Holder<ContextFloatProvider> bonusRolls;
