...
/**
 * Frostworld (Europa) sky — permanent night with a faint icy wash by day.
 */
public final class FrostworldAtmosphere {
	public static final int NIGHT_SKY_COLOR = 0x00000A;
	public static final int DAY_HAZE_COLOR = 0xA8C8E0;
	public static final float DAY_HAZE_BLEND = 0.08F;
	public static final float STAR_BRIGHTNESS = 0.55F;

	private FrostworldAtmosphere() {
	}
