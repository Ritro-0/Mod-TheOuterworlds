...
/**
 * Liquid helium: water-like sprint-swim (including the prone swim pose),
 ...
 * Gravity buoyancy is normalized so Deepworld's high g does not pin you to the seafloor.
 */
public final class LiquidHeliumFluidInteractions {
	...
	private LiquidHeliumFluidInteractions() {
	}
	...
	public static void register() {
		...
		EntityFluidInteractionRegistry.register(ModTags.LIQUID_HELIUM, new FluidBehavior() {
			@Override
			...
			public void travelInFluid(
				...
				// Horizontal swim boost stays; climbing through He should feel heavy.
				if (motion.y > 0.0) {
	...
	private static void burnEntity(Entity entity) {
		...
		if (entity instanceof LivingEntity living
			&& IridiumProtection.countIridiumPieces(living) >= DeepworldLayers.DEEPWORLD_IRIDIUM_PIECES) {
			entity.clearFire();
			return;
		}
