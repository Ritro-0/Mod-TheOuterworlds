...
public class OxidizableIronBarsBlock extends IronBarsBlock implements WeatheringCopper {
    private final WeatheringCopper.WeatherState degradationLevel;
    private Block waxedVersion;

    public OxidizableIronBarsBlock(WeatheringCopper.WeatherState degradationLevel, Properties settings) {
        super(settings);
    ...
    public ItemStack getPickStack(LevelReader world, BlockPos pos, BlockState state) {
        ...
        return new ItemStack(net.minecraft.world.level.block.Blocks.IRON_BARS);
    }
}
