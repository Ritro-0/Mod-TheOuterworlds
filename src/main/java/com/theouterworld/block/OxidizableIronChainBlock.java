...
public class OxidizableIronChainBlock extends ChainBlock implements WeatheringCopper {
    private final WeatheringCopper.WeatherState degradationLevel;
    private Block waxedVersion;

    public OxidizableIronChainBlock(WeatheringCopper.WeatherState degradationLevel, Properties settings) {
        super(settings);
    ...
    public ItemStack getPickStack(LevelReader world, BlockPos pos, BlockState state) {
        ...
        return new ItemStack(net.minecraft.world.level.block.Blocks.IRON_CHAIN);
    }
}
