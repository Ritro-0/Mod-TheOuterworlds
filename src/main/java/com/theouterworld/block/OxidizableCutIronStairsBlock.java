...
public class OxidizableCutIronStairsBlock extends StairBlock implements WeatheringCopper {
    private final WeatheringCopper.WeatherState degradationLevel;
    private Block waxedVersion;

    public OxidizableCutIronStairsBlock(BlockState baseBlockState, WeatheringCopper.WeatherState degradationLevel, Properties settings) {
