...
public class ForgePlateMenu extends ItemCombinerMenu {
	...
	public ForgePlateMenu(int containerId, Inventory inventory) {
		this(containerId, inventory, ContainerLevelAccess.NULL);
	}

	public ForgePlateMenu(int containerId, Inventory inventory, ContainerLevelAccess access) {
		this(containerId, inventory, access, inventory.player.level());
	}

	private ForgePlateMenu(int containerId, Inventory inventory, ContainerLevelAccess access, Level level) {
		super(ModScreenHandlers.FORGE_PLATE_SCREEN_HANDLER, containerId, inventory, access, createInputSlotDefinitions(level.recipeAccess()));
		this.level = level;
	...
	protected boolean isValidBlock(BlockState state) {
		return state.is(ModBlocks.FORGE_PLATE);
	}
